...
**Figure \ref{fig:length}** above shows that shorter film are more likely to be predicted as a highly rated film, this may be due to some correlation between LENGTH and SHORT in the film genres, as we can see by doing visualizations before, most of the short films received positive reviews.

\
**Figure \ref{fig:budget}**: As with the results of the previous exploratory data analysis, the higher the budget, the more likely it is that the film will be well received in the future.

\
**Figure \ref{fig:votes}**: The votes, while also contributing to the film's rating, is less effective in terms of predicting results, due to the graph that the more votes there are, the wider the predicted range.
