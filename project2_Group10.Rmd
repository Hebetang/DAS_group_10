...
**Figure \ref{fig:prob}** above shows that Documentary is predicted to have a high probability to be rated greater than 7. Comedy and short films are predicted to have a moderate probability  to be rated above 7. The probability of other films receiving a rating above 7 is low.
