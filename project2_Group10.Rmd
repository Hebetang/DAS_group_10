...
grid.arrange(p1,p2,p3,p4, 
             ...
             ncol = 2,nrow=2)
```
• **Figure(a)**: There are **zero** potential outliers. The year has little effect on the films rating, the left and right bars' distributions look like the same, and the median of the year distribution of the different rated films is basically in the same level range.
...
• **Figure(d)**: There are **all potential outliers**. The distributions appear to be similar, but the distribution on the left clearly has more extreme values and requires further discussion.
\
...
```
**Figure 5** above shows that shorter film are more likely to be predicted as a highly rated film, this may be due to some correlation between LENGTH and SHORT in the film genres, as we can see by doing visualizations before, most of the short films received positive reviews.
