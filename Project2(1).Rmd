...
From the results it is clear that:
 ...
 •  The slope of the Year variable is estimated to be positive, which means that, all else being equal, films released later are more likely to receive a higher rating. In the parametric test, it has a high p-value, so it has a high probability of being a non-significant variable.
 ...
 •  A positive odds estimate for budge means that, all else being equal, the higher the budget, the more likely it is that the film will have a high rating.
 ...
 •  Different film categories all have different effects on film ratings; for example, when all else is equal, films in the Animation/ Drama/ Romance category are less likely to be well-received; films in the Comdy/ Documentary/ Short category are more likely to be well-recognised.
...
**figure \ref{fig:Odds}** above shows the odds ratios of each variables.A red number indicates that the variable it corresponds to has a negative impact on the movie rating, and conversely, the variable corresponding to a blue number has a positive impact on the movie.
